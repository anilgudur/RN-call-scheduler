...
import { BackIcon, HeaderTitle, AddCallHeader } from "../../Header/Headers";
...
export default class RecurringScreen extends Component {
  ...
  static navigationOptions = (
    ...
    return {
      headerLeft: (
        <BackIcon navigation={navigation} onPress={() => goBack(null)} />
      ),
      headerTitle: <HeaderTitle titleName={"Recurring"} />,
      headerRight: <View />
    };
  };
  ...
  async openDate() {
    console.log(
      "this.props.addCall.recurring.endDate::: ",
      this.props.addCall.recurring.endDate
    );
    try {
      ...
      if (action !== DatePickerAndroid.dismissedAction) {
        ...
        this.props.recurringDateSelect(
    ...
    return (
      <View style={gStyle.container}>
        ...
        <View style={gStyle.radioRow}>
          <TouchableHighlight
            onPress={() => {
              this.setRecurringType(rdOptionRecurring.doNotRepeat);
            }}
            underlayColor={stylesColors.button_underlay_color}
          >
            <View
              style={[
                gStyle.radioTouchableRow,
            ...
            >
              <Icon
                ...
                color={stylesColors.radio_icon_color}
                size={styleValues.radio_size}
              />
        ...
        <View style={gStyle.radioRow}>
          <TouchableHighlight
            onPress={() => {
              this.setRecurringType(rdOptionRecurring.daily);
            }}
            underlayColor={stylesColors.button_underlay_color}
          >
            <View
            ...
            >
              <Icon
                name={
                  this.props.addCall.recurring.on == rdOptionRecurring.daily
                    ? "radio-button-checked"
                    : "radio-button-unchecked"
                }
                color={stylesColors.radio_icon_color}
        ...
        <View style={gStyle.radioRow}>
          <TouchableHighlight
            onPress={() => {
              this.setRecurringType(rdOptionRecurring.weekly);
            }}
            underlayColor={stylesColors.button_underlay_color}
          >
            <View
        ...
        <View style={gStyle.radioRow}>
          <TouchableHighlight
            onPress={() => {
              this.setRecurringType(rdOptionRecurring.monthly);
            }}
            underlayColor={stylesColors.button_underlay_color}
          >
            <View
            ...
            >
              <Icon
                name={
                  this.props.addCall.recurring.on == rdOptionRecurring.monthly
                    ? "radio-button-checked"
                    : "radio-button-unchecked"
                }
                color={stylesColors.radio_icon_color}
          ...
          <TouchableHighlight
            onPress={() => {
              this.props.addCall.recurring.on == rdOptionRecurring.doNotRepeat
                ? null
                : this.rdRecurringEndDateSelect(
                    rdOptionRecurringEndDate.forever
                  );
            }}
            underlayColor={
              this.props.addCall.recurring.on == rdOptionRecurring.doNotRepeat
                ? "transparent"
                : stylesColors.button_underlay_color
            }
          >
            <View
              style={[
            ...
            >
              <Icon
                ...
                color={
                  this.props.addCall.recurring.on ==
                  rdOptionRecurring.doNotRepeat
                    ? stylesColors.icon_color_disabled
                    : stylesColors.radio_icon_color
                }
                size={styleValues.radio_size}
                onPress={() => {}}
              />
              <Text
                style={[
                  ...
                  this.props.addCall.recurring.on ===
                  rdOptionRecurring.doNotRepeat
                    ? { color: stylesColors.text_color_disabled }
                    : { color: stylesColors.text_color_enabled }
                ]}
              >
                Forever
              </Text>
        ...
        >
          ...
          >
            <TextInput
              ...
              value={moment(this.props.addCall.recurring.endDate).format(
                "MMM DD, YYYY"
              )}
              editable={
                this.props.addCall.recurring.on == rdOptionRecurring.doNotRepeat
